...
Task.create!(title: "Add Loader", user_id: user1.id, project_id: project3.id, due_date:format_date("02/01/2020") )
Task.create!(title: "notifications", user_id: user1.id, project_id: project3.id, due_date:format_date("02/01/2020") )
Task.create!(title: "teams page", user_id: user1.id, project_id: project3.id, due_date:format_date("02/01/2020") )
Task.create!(title: "accept team invite", user_id: user1.id, project_id: project3.id, due_date:format_date("02/01/2020") )
Task.create!(title: "task filters", user_id: user1.id, project_id: project3.id, due_date:format_date("02/01/2020") )
Task.create!(title: "add complete button to cal task", user_id: user1.id, project_id: project3.id, due_date:format_date("02/01/2020") )
Task.create!(title: "chat and team feed", user_id: user1.id, project_id: project3.id, due_date:format_date("02/01/2020") )
Task.create!(title: "comments and updates for tasks", user_id: user1.id, project_id: project3.id, due_date:format_date("02/01/2020") )